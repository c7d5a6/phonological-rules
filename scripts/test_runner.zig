//! Test runner based on Zig 0.16 `lib/compiler/test_runner.zig`.
//! Debug `--fuzz` fails in the stock runner: it passes a `builtin.StackTrace`
//! to `debug.writeStackTrace`. This copy uses `writeErrorReturnTrace` instead.
